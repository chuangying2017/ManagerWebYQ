    ...
    <div class="Huiform">
        <form id="myFormSubmit">
            ...
            <table class="table table-bg">
                ...
                <tr>
                    <th></th>
                    <td><button class="btn btn-success radius" type="submit" onclick='admin_permission_add("{{route('manager.permissionAdd')}}")'><i class="icon-ok"></i> 确定</button></td>
                </tr>
                </tbody>
            </table>
        </form>
...
<script type="text/javascript" src="{{asset('commonjs/admin-js.js')}}"></script>