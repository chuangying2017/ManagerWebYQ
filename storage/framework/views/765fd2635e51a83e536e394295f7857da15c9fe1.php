...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius">
            ...
            <a href="javascript:;" onclick="admin_permission_add('添加权限节点','<?php echo e(url('TestAdmin/manager/permission-add')); ?>','380','310')" class="btn btn-primary radius">
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="<?php echo e(asset('hui-admin/lib/datatables/1.10.0/jquery.dataTables.min.js')); ?>"></script>
